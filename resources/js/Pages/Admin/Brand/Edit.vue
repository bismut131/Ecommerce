    ...
    <div class="flex justify-center">
        ...
        <div class="flex justify-center">
            <div class="flex bg-white rounded-2xl m-5 p-5 sm:max-w-md grow sm:mt-5">
                <form @submit.prevent="form.put(route('admin.brand.update', brand.id))" class="mt-6 space-y-6">
                    <div class="mt-3">
                ...
                <form @submit.prevent="form.delete(route('admin.brand.destroy', brand.id))" class="mt-6 space-y-6">
                    <div class="flex justify-items-center justify-self-end">
